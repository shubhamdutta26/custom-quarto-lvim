...
-- Remap notification history from <leader>n to <leader>N
-- First remove the default LazyVim mapping
vim.keymap.del("n", "<leader>n")

-- Then add your own mapping
vim.keymap.set("n", "<leader>N", function()
  -- Snacks notification history picker
  require("snacks").picker.notifications()
end, { silent = true, noremap = true, desc = "Notification history" })
